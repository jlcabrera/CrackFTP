...
public class CrackFTP {
    ...
    public static boolean validarParametros(String[] params){
        ...
        // Empezamos comprobando si existen los ficheros que nos pasan por parametros llamando a otro metodo
        ficherosValidos = validarFicheros(u, c);
        
        //Comprobamos con el siguiente metodo si el parametro numero de hilos está o no, y si es así asignamos el numero de hilos
    ...
    //metodo para validar los ficheros que nos deberan de pasar por parametros cuando ejecuten la aplicacion
    ...
    //metodo para validar si nos han pasado un numero determinado de hilos o no;
        ...
        if(!hilos.equalsIgnoreCase("")){
            ...
            CrackFTP.hilos = Integer.valueOf(hilos);
             valido = true;
                ...
                System.out.println("El parámetro correspondiente al número de hilos no es correcto");
            }
        }else{
